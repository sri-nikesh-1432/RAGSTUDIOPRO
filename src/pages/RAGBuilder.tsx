...
import {
  ...
  Headphones, Film, ChevronLeft, ChevronRight
} from 'lucide-react';
import { cn, formatNumber } from '../lib/utils';
import { useAppStore } from '../store/appStore';
import {
  parseAPI, chunkAPI, embedAPI, vectorAPI, retrieveAPI, llmAPI, healthAPI, uploadAPI
} from '../services/api';
...
function KnowledgeBasePanel({ store, textInputRef, audioInputRef, videoInputRef,
  ...
  isUploading, uploadProgress, uploadingCategory }: {
  store: any;
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-accent-primary/5 to-accent-dim/5 rounded-xl border border-accent-primary/20 p-4">
                ...
                <p className="text-[10px] text-text-muted mt-3">
                  Set your <code className="text-accent-primary font-mono">GROQ_API_KEY</code> in <code className="text-accent-primary font-mono">backend/.env</code>
                </p>
              </div>
            </div>
          </StepContent>
